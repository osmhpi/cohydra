window.addEventListener('load', function() {
    ...
    var branches = ["master", "add-license", "bugfix/docsbuild", "feature/non-root-user", "gh-pages", "interface-node", "linting", "network-base", "readme-documentation", "refactor/network"];
