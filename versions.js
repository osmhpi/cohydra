window.addEventListener('load', function() {
    ...
    var branches = ["master", "add-license", "bugfix/docsbuild", "bugfix/sumo-gui", "feature/lxd-nodes", "feature/non-root-user", "feature/wifi_802_11p", "gh-pages", "separate-visualisation"];
