window.addEventListener('load', function() {
    ...
    var branches = ["master", "bugfix/sumo-gui", "feature/lxd-nodes", "feature/non-root-user", "feature/sumo/step-length", "feature/wifi_802_11p", "gh-pages", "travis-basic-example"];
