...
The :src:`cohydra-base <container-images/cohydra-base/Dockerfile>` installs all neccessary dependencies for cohydra,
:src:`cohydra-dev <container-images/cohydra-dev/Dockerfile>` is for development purposes (docker-cli in the container).
